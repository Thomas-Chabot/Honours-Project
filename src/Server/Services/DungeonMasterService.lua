...
-- Checks if a player is the current dungeon master
function DungeonMasterService:IsDungeonMaster(player)
    print("The dungeon master is ", dungeonMaster)
    return dungeonMaster == player
end
